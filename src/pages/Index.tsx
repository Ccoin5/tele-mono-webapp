        ...
        <Card className="p-6 dark:bg-gray-800 dark:border-gray-700">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0">
              <h2 className="text-xl font-semibold mb-2 text-telegram-primary dark:text-telegram-light">Наш чат-бот</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <a href="https://t.me/monoptica_bot" target="_blank" rel="noopener noreferrer">
              <Button className="bg-telegram-primary hover:bg-telegram-dark text-white text-base">
